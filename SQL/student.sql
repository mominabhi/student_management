...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 27, 2018 at 03:13 PM
...
(3, '2018_11_27_073933_create_student_infos_table', 1);
...
CREATE TABLE `student_infos` (
  ...
  `SGPA` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `CGPA` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `student_infos` (`id`, `student_name`, `student_id`, `father_name`, `mother_name`, `program`, `semester`, `SGPA`, `CGPA`, `created_at`, `updated_at`) VALUES
(6, 'abhi', '3178', 'waliar Rahman', 'Hamida Begum', 'B.Sc in CSE', 'spring,18', '3.80', '3.90', NULL, NULL),
(8, 'biplob', '3103', 'somser mulla', 'asia begum', 'B.Sc in Civil', 'spring,18', '3.79', '3.90', NULL, NULL);
